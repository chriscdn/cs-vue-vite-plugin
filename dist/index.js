...
const ae = Symbol("session"), he = Symbol("config"), Mt = Symbol("snackbar"), ar = Symbol(
...
export {
  ...
  Ll as createVueVitePlugin,
  zl as createVueViteRegisterComponentsPlugin,
