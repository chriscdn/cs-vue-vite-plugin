(function(global, factory) {
  typeof exports === "object" && typeof module !== "undefined" ? module.exports = factory(require("vue"), require("vue3-click-away"), require("lodash.get"), require("@chriscdn/promise-semaphore"), require("date-fns"), require("body-scroll-lock"), require("build-url"), require("js-cookie"), require("lodash.debounce"), require("@kweli/cs-rest")) : typeof define === "function" && define.amd ? define(["vue", "vue3-click-away", "lodash.get", "@chriscdn/promise-semaphore", "date-fns", "body-scroll-lock", "build-url", "js-cookie", "lodash.debounce", "@kweli/cs-rest"], factory) : (global = typeof globalThis !== "undefined" ? globalThis : global || self, global.CSVueVitePlugin = factory(global.Vue, global.vue3ClickAway, global.get, global.Semaphore, global.dateFns, global.bodyScrollLock, global.buildUrl, global.cookies, global.debounce, global.csRest));
})(this, function(vue, vue3ClickAway, get, Semaphore, dateFns, bodyScrollLock, buildUrl, cookies, debounce, csRest) {
  "use strict";
  const clickable = {
    props: {
      disabled: {
  ...
  const _sfc_main$y = {
    directives: {
      ClickAway: vue3ClickAway.directive
    },
    // model: {
    //     prop: 'value',
    //     event: 'change',
  ...
  function _sfc_render$y(_ctx, _cache, $props, $setup, $data, $options) {
    ...
    return vue.withDirectives((vue.openBlock(), vue.createElementBlock("div", {
      ...
      vue.renderSlot(_ctx.$slots, "prepend", { item: $options.localValue }),
      vue.createElementVNode("div", _hoisted_1$s, [
        ...
        $data.focus && $props.items.length && !!$data.inputText ? (vue.openBlock(), vue.createElementBlock("div", _hoisted_3$9, [
  ...
  const _sfc_main$x = vue.defineComponent({
    setup() {
      const session = vue.inject("session", {});
      return { session };
    },
    props: {
      nodeRec: {
  ...
  function _sfc_render$x(_ctx, _cache, $props, $setup, $data, $options) {
    ...
    return _ctx.nodeRecResolved ? (vue.openBlock(), vue.createElementBlock("span", _hoisted_1$r, [
      ...
      }, vue.toDisplayString(_ctx.nodeRecResolved.name), 9, _hoisted_3$8),
      _ctx.clickable ? (vue.openBlock(), vue.createBlock(_component_KFunctionMenu, {
        key: 1,
  ...
  const _sfc_main$u = {
    ...
    methods: {
      ...
      formatForDatePicker(value) {
        ...
        if (d) {
          if (this.time) {
            return dateFns.format(d, "yyyy-MM-dd'T'HH:mm:ss");
          } else {
  ...
  const _sfc_main$t = {
    ...
    watch: {
      ...
      async dialog(value) {
        ...
        if (value) {
          await this.$nextTick();
          bodyScrollLock.disableBodyScroll(this.$refs.content);
        } else {
          bodyScrollLock.enableBodyScroll(this.$refs.content);
        }
      }
    },
    mounted() {
  ...
  function _sfc_render$r(_ctx, _cache, $props, $setup, $data, $options) {
    return vue.openBlock(), vue.createElementBlock("div", null, [
      _ctx.label ? (vue.openBlock(), vue.createElementBlock("div", _hoisted_1$o, vue.toDisplayString(_ctx.label), 1)) : vue.createCommentVNode("", true),
      vue.renderSlot(_ctx.$slots, "default"),
  ...
  function _sfc_render$q(_ctx, _cache, $props, $setup, $data, $options) {
    return _ctx.dataid ? (vue.openBlock(), vue.createElementBlock("span", _hoisted_1$n, [
      vue.createElementVNode("a", {
        id: _ctx.aid,
        href: "#",
        class: "functionMenuHotspot",
        onClick: _cache[2] || (_cache[2] = vue.withModifiers((...args) => _ctx.onclick && _ctx.onclick(...args), ["prevent"]))
      }, [
        _ctx.isModernFunctionMenu ? (vue.openBlock(), vue.createElementBlock("img", {
          key: 0,
          src: `${_ctx.config.img}spacer.gif`,
          alt: "Functions"
        }, null, 8, _hoisted_3$7)) : (vue.openBlock(), vue.createElementBlock("img", {
          key: 1,
          id: _ctx.xid,
          src: _ctx.image,
          border: "0",
    ...
    return vue.openBlock(), vue.createBlock(_component_KCard, { class: "k-multi" }, {
      default: vue.withCtx(() => [
        vue.createVNode(vue.TransitionGroup, {
          ...
          default: vue.withCtx(() => [
            (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList($options.valueLocal, (value, index2) => {
              return vue.openBlock(), vue.createElementBlock("div", {
                key: `k-multi-${value}`,
                class: "k-multi-item"
              }, [
  ...
  function _sfc_render$n(_ctx, _cache, $props, $setup, $data, $options) {
    ...
    return vue.openBlock(), vue.createBlock(_component_KCard, { class: "k-multi" }, {
      default: vue.withCtx(() => [
            ...
            (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList($options.valueLocal, (value, index2) => {
              return vue.openBlock(), vue.createElementBlock("div", {
                ...
                vue.createElementVNode("div", _hoisted_1$k, [
                  vue.renderSlot(_ctx.$slots, "readonly", {
                    index: index2,
                    value
                  }, () => [
        ...
        $options.canAdd ? vue.renderSlot(_ctx.$slots, "add", {
          key: 0,
          add: $options.add
        }) : vue.createCommentVNode("", true)
      ]),
  ...
  function _sfc_render$m(_ctx, _cache, $props, $setup, $data, $options) {
    return vue.openBlock(), vue.createElementBlock("div", _hoisted_1$j, [
      (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList(_ctx.breadcrumb, (item, index2) => {
        return vue.openBlock(), vue.createElementBlock(vue.Fragment, {
          key: item.dataid
        }, [
          vue.createTextVNode(vue.toDisplayString(item.name) + " ", 1),
          index2 < _ctx.breadcrumb.length - 1 ? (vue.openBlock(), vue.createElementBlock(vue.Fragment, { key: 0 }, [
            vue.createTextVNode(" ▶ ")
          ], 64)) : vue.createCommentVNode("", true)
        ], 64);
      }), 128))
  ...
  function _sfc_render$l(_ctx, _cache, $props, $setup, $data, $options) {
    const _component_KButton = vue.resolveComponent("KButton");
    const _component_KNodeAncestor = vue.resolveComponent("KNodeAncestor");
    return vue.openBlock(), vue.createElementBlock("div", _hoisted_1$i, [
      ...
      vue.createVNode(_component_KButton, {
        ...
        default: vue.withCtx(() => [
          vue.createTextVNode(vue.toDisplayString(_ctx.browseButtonLabel), 1)
        ]),
        _: 1
      }, 8, ["onClick"]),
      _ctx.clearable ? (vue.openBlock(), vue.createBlock(_component_KButton, {
        key: 0,
        small: "",
        onClick: _ctx.clear
      }, {
        default: vue.withCtx(() => [
          vue.createTextVNode(vue.toDisplayString(_ctx.clearButtonLabel), 1)
        ]),
        _: 1
      }, 8, ["onClick"])) : vue.createCommentVNode("", true),
      _ctx.dataid ? (vue.openBlock(), vue.createBlock(_component_KNodeAncestor, {
        key: 1,
        dataid: _ctx.dataid
      }, null, 8, ["dataid"])) : vue.createCommentVNode("", true)
    ]);
    ...
    return vue.openBlock(), vue.createBlock(_component_KDialog, {
      ...
      default: vue.withCtx(() => [
        vue.createElementVNode("div", _hoisted_1$h, [
          ...
          vue.createElementVNode("div", _hoisted_2$a, vue.toDisplayString($props.label), 1)
        ])
      ]),
      _: 1
    }, 8, ["model-value"]);
  ...
  function _sfc_render$i(_ctx, _cache, $props, $setup, $data, $options) {
    return vue.openBlock(), vue.createElementBlock("h1", null, [
      ...
      $props.subtitle ? (vue.openBlock(), vue.createElementBlock("span", _hoisted_1$g, [
        vue.createTextVNode(": "),
        vue.createElementVNode("span", _hoisted_2$9, vue.toDisplayString($props.subtitle) + " - 2", 1)
      ])) : vue.createCommentVNode("", true)
    ]);
  }
  ...
  function _sfc_render$h(_ctx, _cache, $props, $setup, $data, $options) {
    ...
    return $props.pagination.hasOtherPages ? (vue.openBlock(), vue.createElementBlock("div", _hoisted_1$f, [
            ...
            vue.withDirectives(vue.createElementVNode("select", {
              ...
              (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList($props.items, (item) => {
                return vue.openBlock(), vue.createElementBlock("option", {
                  key: $options.getItemValue(item),
                  value: $options.getItemValue(item)
                }, vue.toDisplayString($options.getItemText(item)), 9, _hoisted_2$5);
              }), 128))
            ], 2), [
  ...
  function _sfc_render$b(_ctx, _cache, $props, $setup, $data, $options) {
    return vue.openBlock(), vue.createElementBlock("a", {
      ...
      vue.createVNode(vue.Transition, {
        ...
        default: vue.withCtx(() => [
          $options.isActive && $options.sortAsc ? (vue.openBlock(), vue.createElementBlock("span", _hoisted_1$a, "↓")) : $options.isActive ? (vue.openBlock(), vue.createElementBlock("span", _hoisted_2$3, "↑")) : vue.createCommentVNode("", true)
        ]),
        _: 1
      })
    ]);
  ...
  const _hoisted_1$8 = /* @__PURE__ */ vue.createElementVNode("circle", {
    cx: "12",
    cy: "12",
    r: "10",
    stroke: "currentColor",
  ...
  const _hoisted_1$7 = /* @__PURE__ */ vue.createElementVNode("span", { class: "k-switch-slider" }, null, -1);
  const _hoisted_2$1 = [
    _hoisted_1$7
  ];
  ...
  function _sfc_render$6(_ctx, _cache, $props, $setup, $data, $options) {
    const _component_KFormFieldWrapper = vue.resolveComponent("KFormFieldWrapper");
    return vue.openBlock(), vue.createBlock(_component_KFormFieldWrapper, {
      label: _ctx.label,
      "success-messages": _ctx.successMessages,
      "error-messages": _ctx.errorMessages
    }, {
  ...
  function _sfc_render$4(_ctx, _cache, $props, $setup, $data, $options) {
    return _ctx.url ? (vue.openBlock(), vue.createElementBlock("img", {
      key: 0,
      src: _ctx.url,
      style: vue.normalizeStyle([_ctx.measurableStyles])
    }, null, 12, _hoisted_1$4)) : vue.createCommentVNode("", true);
  }
  ...
  function _sfc_render$3(_ctx, _cache, $props, $setup, $data, $options) {
    ...
    return _ctx.userRecLocal ? (vue.openBlock(), vue.createElementBlock("span", _hoisted_1$3, [
      _ctx.gif ? (vue.openBlock(), vue.createBlock(_component_KUserGIF, {
        key: 0,
      ...
      vue.createElementVNode("a", {
        href: "#",
        onClick: _cache[0] || (_cache[0] = vue.withModifiers((...args) => _ctx.click && _ctx.click(...args), ["prevent"]))
      }, vue.toDisplayString(_ctx.displayName), 1)
    ])) : vue.createCommentVNode("", true);
  }
  ...
  function _sfc_render$2(_ctx, _cache, $props, $setup, $data, $options) {
    ...
    return vue.openBlock(), vue.createBlock(_component_KFormFieldWrapper, {
      ...
      default: vue.withCtx(() => [
        _ctx.editable ? (vue.openBlock(), vue.createBlock(_component_KAutocomplete, {
          key: 0,
          ...
          _: 1
        }, 8, ["modelValue", "search-input", "placeholder", "width", "loading", "items", "return-object"])) : (vue.openBlock(), vue.createBlock(_component_KUserLink, {
          key: 1,
  ...
  const index = {
    install(app, options) {
      ...
      const session = new csRest.Session(options);
