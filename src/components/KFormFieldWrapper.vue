<template>
    <div>
        <div v-if="label" class="k-form-field-label">{{ label }}</div>
        <slot></slot>
        <div v-for="(successMessage, index) in successMessages" :key="index" class="k-formfield--success">
            {{ successMessage }}
        </div>
        <div v-for="(errorMessage, index) in errorMessages" :key="index" class="k-formfield--error">
            {{ errorMessage }}
        </div>
    </div>
</template>
