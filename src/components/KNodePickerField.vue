<template>
    <div class="k-node-picker-field">
        <input ref="input" type="text" class="k-input" :value="name" @focus="openWindow" />
        <KButton small @click="openWindow">{{ browseButtonLabel }}</KButton>
        <KButton small @click="clear">{{ clearButtonLabel }}</KButton>
        <div class="k-node-picker-breadcrumb" v-html="breadcrumbString"></div>
    </div>
</template>
